...
//NRF2401片选信号
#define 		CE_L      GPIO_ResetBits(GPIOA, GPIO_Pin_4)
#define 		CE_H      GPIO_SetBits(GPIOA, GPIO_Pin_4)
...
//SPI片选信号	
#define 		CSN_L     GPIO_ResetBits(GPIOA, GPIO_Pin_3)
#define 		CSN_H     GPIO_SetBits(GPIOA, GPIO_Pin_3)
...
//IRQ中断脚
#define 		IRQ_L     	GPIO_ResetBits(GPIOB,GPIO_Pin_0) 
#define 		IRQ_H     	GPIO_SetBits(GPIOB,GPIO_Pin_0)
  
#define 		READ_IRQ    GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)
